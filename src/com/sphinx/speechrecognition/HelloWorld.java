	...
	public static void main(String[] args) throws InterruptedException {
		try {
			...
			if (microphone.startRecording()) {
				System.out
						.println("Say: (Command | Program| Browser | Bluetooth |  Device Manager |Power Options |Cal | Control | Player |task manager | Windows Security Center)");
				System.out
						.println("Say: ( open word | open phot oshop|open Access|start Excel|start nero |start fire wall| open Pad |open Paint)");
				while (true) {
					...
					if (result != null) {
						...
						if (resultText
								.equalsIgnoreCase("Windows Security Center")) {
							try {
								 // resultText="";
								p = Runtime.getRuntime().exec(
										"cmd /c wscui.cpl");
							...
							try {
								...
								p = Runtime
										.getRuntime()
										.exec("cmd /c start taskkill /im mspaint.exe /f");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
						} else if (resultText
								.equalsIgnoreCase("close calculator")) {
							try {
								
								// resultText="";
								p = Runtime
										.getRuntime()
										.exec("cmd /c start taskkill /im calc.exe /f");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
							...
							try {
								...
								p = Runtime
										.getRuntime()
										.exec("cmd /c start taskkill /im chrome.exe /f");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
						}
							...
							try {
								...
								// resultText="";
								p = Runtime.getRuntime().exec(
										"cmd /c start acrord32.exe");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
						} else if (resultText
								.equalsIgnoreCase("site face book")) {
							try {
							...
							try {
								...
								.equalsIgnoreCase("close task manager")) {
							try {
								
								// resultText="";
								p = Runtime
										.getRuntime()
										.exec("cmd /c start taskkill /im taskmgr.exe /f");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
							...
							try {
								...
								p = Runtime
										.getRuntime()
										.exec("cmd /c start taskkill /im notepad.exe /f");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
							...
							try {
								...
								p = Runtime
										.getRuntime()
										.exec("cmd /c start taskkill /im winword.exe /f");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
						} else if (resultText
								.equalsIgnoreCase("start word pad")) {
							try {
								 // resultText="";
							...
							try {
								...
								p = Runtime
										.getRuntime()
										.exec("cmd /c  start taskkill /im wordpad.exe /f");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
						}
							...
							try {
								...
								p = Runtime
										.getRuntime()
										.exec("cmd /c start taskkill /im excel.exe /f");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
						} else if (resultText
								.equalsIgnoreCase("start firewall")) {
							try {
								 // resultText="";
								p = Runtime.getRuntime().exec(
										"cmd /c start firewall.cpl");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
						} else if (resultText
								.equalsIgnoreCase("close fire wall")) {
							try {
								 // resultText="";
							...
							try {
								...
								p = Runtime
										.getRuntime()
										.exec("cmd /c start taskkill /im msaccess.exe /f");
								// System.out.println("inside");
							} catch (Exception ae) {
							}
						} else if (resultText
							...
							try {
								...
								.equalsIgnoreCase("stop recognition")) {
							try {
								...
								.equalsIgnoreCase("Device Manager")) {
							try {
								 // resultText="";
								p = Runtime.getRuntime().exec(
